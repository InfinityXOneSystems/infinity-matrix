...
const LandingPage = () => {
  ...
  const features = [
    {
      title: "Vision Cortex",
      desc: "The central cognitive engine. Processes multimodal data streams to derive actionable signal and identify high-value opportunities.",
      icon: <Brain size={24} />,
      color: "#3399FF" 
    },
    {
      title: "Quantum X Builder",
      desc: "Generative architectural engine capable of scaffolding complex software infrastructures and digital assets in milliseconds.",
      icon: <Hammer size={24} />,
      color: "#33DDFF" 
    },
    {
      title: "Infinity Intelligence",
      desc: "Self-evolving knowledge base that learns from every interaction, constantly optimizing strategies for maximum efficiency.",
      icon: <Sparkles size={24} />,
      color: "#D946EF" 
    },
    {
      title: "Invention Machine",
      desc: "Autonomous creation suite that takes verified strategies and automatically builds, validates, and launches fully functional products.",
      icon: <Rocket size={24} />,
      color: "#66FF33" 
    }
  ];
        ...
        <section className="min-h-screen flex flex-col items-center justify-center relative px-4 md:px-6 pt-24 md:pt-32 pb-12">
          ...
          <div className="max-w-7xl w-full mx-auto relative z-10 flex flex-col items-center text-center">
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[1.1] mb-8 md:mb-10 drop-shadow-2xl"
        ...
        <section className="py-16 md:py-32 relative">
          <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center mb-16 flex flex-col items-center px-4">
              ...
              <div className="h-1 w-20 bg-[#66FF33] shadow-[0_0_10px_rgba(102,255,51,0.6)] mx-auto mt-4" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, i) => (
                <motion.div
                  ...
                  onClick={() => {
                     if (feature.title.includes("Vision")) navigate('/vision-cortex');
                     if (feature.title.includes("Quantum")) navigate('/quantum-x-builder');
                     if (feature.title.includes("Intelligence")) navigate('/intelligence');
                     if (feature.title.includes("Invention")) navigate('/future');
                  }}
                >
                  <motion.div 
                  ...
                  <h3 
                    className="text-xl font-bold mb-3 text-white transition-colors duration-300 group-hover:text-[var(--card-color)]"
                  >
                    {feature.title}
                  </h3>
                  
                  <p className="text-white/70 text-sm leading-relaxed group-hover:text-white transition-colors flex-grow">
                    {feature.desc}
                  </p>
                  
                  <div className="mt-6 w-8 h-1 rounded-full bg-white/10 group-hover:bg-[var(--card-color)] transition-colors duration-300" />
                </motion.div>
              ))}
            </div>
          </div>
              ...
              <form onSubmit={handleRequestAccess} className="max-w-md mx-auto mb-12 space-y-4 text-left">
                <div>
                  ...
                  <input 
                    ...
                    required
                    className="w-full px-6 py-4 rounded-xl bg-black/40 border border-silver-border-color focus:border-[#3399FF] focus:ring-1 focus:ring-[#3399FF] outline-none transition-all text-white placeholder:text-white/20 shadow-inner backdrop-blur-sm"
                  />
                </div>
