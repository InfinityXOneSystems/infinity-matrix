...
from infinity_matrix.models import RawData, NormalizedData
...
class NormalizationPipeline:
    ...
    def _extract_title(self, raw_data: RawData) -> Optional[str]:
    ...
    def _extract_description(self, raw_data: RawData) -> Optional[str]:
