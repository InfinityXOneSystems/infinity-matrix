...
class FirestoreIntegration:
    ...
    async def get_vector_document(self, doc_id: str) -> Optional[VectorDocument]:
    ...
    async def get_relational(self, collection: str, doc_id: str) -> Optional[Dict[str, Any]]:
...
# Singleton instance
_firestore_instance: Optional[FirestoreIntegration] = None
